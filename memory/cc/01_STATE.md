...
1. ~~每周可投入小时数~~ **已确认（2026-09-09）**：每周 5 次 × 3 小时 = 15 小时。满配 12 h 20 m，**走满配**，一次一张卡，每次余 60 分钟。六次做完：本周 Day 0–4，下周第一次 Day 5 + Gate。
2. ~~许可边界~~ **已确认（2026-09-09）**：用户确认本项目不用于任何商业活动，只是个人练习，`cc-by-nc-2.0` 非商用条款不触及边界。用途变化时需重新评估。
